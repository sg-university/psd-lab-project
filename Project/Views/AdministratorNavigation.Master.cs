...
{
    public partial class AdministratorNavigation : System.Web.UI.MasterPage
    {
        ...
        protected void ButtonManageMember_Click(object sender, EventArgs e)
        {
            HttpContext.Current.Response.Redirect("/Views/ManageMemberPage.aspx");
        }

        protected void ButtonManageEmployee_Click(object sender, EventArgs e)
        {
