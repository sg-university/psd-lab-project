...
namespace Project.Handlers
{
    public class EmployeeAuthenticationHandler
    {
        ...
        public Result Register(MsEmployee toCreateMsEmployee)
        {
            Result res = new Result();
            Boolean isEmailRegistered = MsEmployeeRepository.ReadAll().Exists(x => x.EmployeeEmail.Equals(toCreateMsEmployee.EmployeeEmail));
            ...
            MsEmployee createdMsEmployee = MsEmployeeRepository.CreateOne(toCreateMsEmployee);
            res.SuccessCode = "200";
            res.SucessMessage = "Succeed to register a MsEmployee";
            res.Data = createdMsEmployee;
