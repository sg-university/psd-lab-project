...
namespace Project.Handlers
{
    public class MemberAuthenticationHandler
    {
        ...
        public Result Register(MsMember toCreateMsMember)
        {
            Result res = new Result();
            Boolean isEmailRegistered = MsMemberRepository.ReadAll().Exists(x => x.MemberEmail.Equals(toCreateMsMember.MemberEmail));
            ...
            MsMember createdMsMember = MsMemberRepository.CreateOne(toCreateMsMember);
            res.SuccessCode = "200";
            res.SucessMessage = "Succeed to register a MsMember";
            res.Data = createdMsMember;
